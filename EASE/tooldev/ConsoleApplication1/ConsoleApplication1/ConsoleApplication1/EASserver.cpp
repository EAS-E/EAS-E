...
#endif
#ifdef _eInstHdr
addEType(E_TXTLIT_F(_T("eInstHdr")),    1,    7, 0);
#endif
#ifdef _Subprogram
addEType(E_TXTLIT_F(_T("Subprogram")),    1,    6, 0);
#endif
#ifdef _iRef
addEType(E_TXTLIT_F(_T("iRef")),    1,    5, 0);
#endif
#ifdef _Reference
addEType(E_TXTLIT_F(_T("Reference")),    1,    4, 0);
#endif
#ifdef _Text
addEType(E_TXTLIT_F(_T("Text")),    1,    3, 0);
#endif
#ifdef _Real
addEType(E_TXTLIT_F(_T("Real")),    1,    2, 0);
#endif
#ifdef _Integer
addEType(E_TXTLIT_F(_T("Integer")),    1,    1, 0);
#endif
#ifdef _UIB_W
addEType(E_TXTLIT_F(_T("UIB_W")),    2,   23, 0);
#endif
#ifdef _UIB_R
addEType(E_TXTLIT_F(_T("UIB_R")),    2,   22, 0);
#endif
#ifdef _LGBLKREP
